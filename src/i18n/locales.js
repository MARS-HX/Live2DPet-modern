...
const I18N = {
  en: {
    ...
    'detect.screenshotInterval': 'Screenshot Interval (sec, 0=every detection)',
  ...
  zh: {
    ...
    'detect.screenshotInterval': '截图间隔（秒，0=每次检测都截）',
  ...
  ja: {
    ...
    'detect.screenshotInterval': 'スクリーンショット間隔（秒、0=毎回）',
