...
const I18N = {
  en: {
    'lang.label': 'Language',
    'tab.settings': 'Settings', 'tab.model': 'Model', 'tab.emotion': 'Emotion', 'tab.tts': 'TTS', 'tab.prompt': 'Prompt',     'tab.tavern': 'Tavern', 'tavern.title': 'Tavern Mode Presets', 'tavern.desc': 'Manage world settings, characters and dialogue for Tavern mode.', 'tavern.new': 'New Preset', 'tavern.import': 'Import JSON', 'tavern.saved': 'Saved Presets', 'tavern.select': '-- Select Preset --', 'tavern.apply': 'Apply', 'tavern.edit': 'Edit', 'tavern.export': 'Export', 'tavern.delete': 'Delete', 'tavern.editor': 'Edit Preset', 'tavern.name': 'Name', 'tavern.descLabel': 'Description', 'tavern.userRole': 'Your Role', 'tavern.aiRole': 'AI Role', 'tavern.greeting': 'Greeting', 'tavern.systemPrompt': 'AI Persona', 'tavern.world': 'World Building', 'tavern.diaryPrompt': 'Diary Prompt', 'tavern.save': 'Save', 'tavern.cancel': 'Cancel', 'tavern.savedMsg': 'Preset saved!', 'tavern.appliedMsg': 'Preset applied! Switch to Tavern mode to use it.', 'tab.enhance': 'Enhance',
    ...
    'detect.screenshotInterval': 'Screenshot Interval (sec, 0=every detection)', 'audio.title': 'Audio Devices', 'audio.input': 'Microphone', 'audio.output': 'Speaker', 'audio.volume': 'Volume',
    'tts.title': 'TTS Configuration',
    'tts.provider': 'TTS Provider',
    'tts.hint': 'Select a TTS provider and fill in the configuration.',
    'tts.apiUrl': 'API Base URL',
    'tts.apiKey': 'API Key',
    'tts.stylePrompt': 'Style Prompt (optional)',
    'tts.format': 'Audio Format',
    'tts.voice': 'Voice',
    'tts.region': 'Region',
    'tts.serviceUrl': 'Service URL',
    'tts.endpoint': 'TTS Endpoint',
    'tts.method': 'Request Method',
    'tts.textParam': 'Text Parameter',
    'tts.speaker': 'Speaker ID',
    'tts.language': 'Language',
    'tts.responseType': 'Response Type',
    'tts.audioPath': 'Audio Field Path',
    'tts.provider.mimo': 'Mimo',
    'tts.provider.aliyun': 'Aliyun TTS',
    'tts.provider.local': 'Local VITS2',
    'tts.responseType.json': 'JSON (base64)',
    'tts.responseType.blob': 'Raw Audio',
    'stt.title': 'Voice Chat (Cloud STT)',
    ...
    'tts.mode.tts': 'TTS Voice Synthesis', 'tts.mode.default': 'Default', 'tts.mode.silent': 'Silent',
    ...
    'tts.test.btn': 'Test Voice', 'tts.diagnose': 'Diagnose TTS',
  ...
  zh: {
    'lang.label': '语言',
    'tab.settings': '设置', 'tab.model': '模型', 'tab.emotion': '表情', 'tab.tts': 'TTS', 'tab.prompt': '角色设定',     'tab.tavern': '酒馆', 'tavern.title': '酒馆模式预设管理', 'tavern.desc': '管理酒馆模式的世界观、角色和对话设定。', 'tavern.new': '新建预设', 'tavern.import': '导入 JSON', 'tavern.saved': '已保存的预设', 'tavern.select': '-- 选择预设 --', 'tavern.apply': '应用', 'tavern.edit': '编辑', 'tavern.export': '导出', 'tavern.delete': '删除', 'tavern.editor': '编辑预设', 'tavern.name': '名称', 'tavern.descLabel': '描述', 'tavern.userRole': '你的角色', 'tavern.aiRole': 'AI 角色', 'tavern.greeting': '开场白', 'tavern.systemPrompt': 'AI 人格设定', 'tavern.world': '世界观', 'tavern.diaryPrompt': '日记提示词', 'tavern.save': '保存', 'tavern.cancel': '取消', 'tavern.savedMsg': '预设已保存！', 'tavern.appliedMsg': '预设已应用，打开酒馆模式即可使用！', 'tab.enhance': '增强',
    'api.title': 'API 配置',
    ...
    'detect.screenshotInterval': '截图间隔（秒，0=每次检测都截）', 'audio.title': '音频设备', 'audio.input': '麦克风', 'audio.output': '扬声器', 'audio.volume': '音量',
    'tts.title': '语音合成 (TTS) 配置',
    'tts.provider': 'TTS 服务商',
    'tts.hint': '选择 TTS 服务商并填写对应配置。',
    'tts.apiUrl': 'API 地址',
    'tts.apiKey': 'API Key',
    'tts.stylePrompt': '风格描述（可选）',
    'tts.format': '音频格式',
    'tts.voice': '音色',
    'tts.region': '地域',
    'tts.serviceUrl': '服务地址',
    'tts.endpoint': 'TTS 接口路径',
    'tts.method': '请求方式',
    'tts.textParam': '文本参数名',
    'tts.speaker': '说话人 ID',
    'tts.language': '语言',
    'tts.responseType': '响应类型',
    'tts.audioPath': '音频字段路径',
    'tts.provider.mimo': '小米蜜模 Mimo',
    'tts.provider.aliyun': '阿里云 TTS',
    'tts.provider.local': '本地 VITS2',
    'tts.responseType.json': 'JSON (base64)',
    'tts.responseType.blob': '直接音频流',
    'stt.title': '语音对话（云端 STT）',
    ...
    'tts.audioMode': '音频模式',
    'tts.mode.tts': 'TTS 语音合成', 'tts.mode.default': '默认', 'tts.mode.silent': '静音',
    ...
    'tts.test.btn': '测试语音', 'tts.diagnose': '诊断 TTS',
  ...
  ja: {
    'lang.label': '言語',
    'tab.settings': '設定', 'tab.model': 'モデル', 'tab.emotion': '表情', 'tab.tts': 'TTS', 'tab.prompt': 'プロンプト',     'tab.tavern': '酒場', 'tavern.title': '酒場モードプリセット管理', 'tavern.desc': '酒場モードの世界観、キャラクター、会話設定を管理します。', 'tavern.new': '新規プリセット', 'tavern.import': 'JSON インポート', 'tavern.saved': '保存済みプリセット', 'tavern.select': '-- プリセット選択 --', 'tavern.apply': '適用', 'tavern.edit': '編集', 'tavern.export': 'エクスポート', 'tavern.delete': '削除', 'tavern.editor': 'プリセット編集', 'tavern.name': '名前', 'tavern.descLabel': '説明', 'tavern.userRole': 'あなたの役割', 'tavern.aiRole': 'AI の役割', 'tavern.greeting': '挨拶', 'tavern.systemPrompt': 'AI 人格設定', 'tavern.world': '世界観', 'tavern.diaryPrompt': '日記プロンプト', 'tavern.save': '保存', 'tavern.cancel': 'キャンセル', 'tavern.savedMsg': 'プリセットを保存しました！', 'tavern.appliedMsg': 'プリセットを適用しました。酒場モードで使用できます！', 'tab.enhance': '拡張',
    'api.title': 'API 設定',
    ...
    'detect.screenshotInterval': 'スクリーンショット間隔（秒、0=毎回）', 'audio.title': 'オーディオ機器', 'audio.input': 'マイク', 'audio.output': 'スピーカー', 'audio.volume': '音量',
    'tts.title': '音声合成 (TTS) 設定',
    'tts.provider': 'TTS プロバイダ',
    'tts.hint': 'TTS プロバイダを選択し、設定を入力してください。',
    'tts.apiUrl': 'API URL',
    'tts.apiKey': 'API Key',
    'tts.stylePrompt': 'スタイル設定（任意）',
    'tts.format': '音声形式',
    'tts.voice': '音色',
    'tts.region': 'リージョン',
    'tts.serviceUrl': 'サービス URL',
    'tts.endpoint': 'TTS エンドポイント',
    'tts.method': 'リクエスト方法',
    'tts.textParam': 'テキストパラメータ',
    'tts.speaker': '話者 ID',
    'tts.language': '言語',
    'tts.responseType': '応答タイプ',
    'tts.audioPath': '音声フィールドパス',
    'tts.provider.mimo': 'Mimo',
    'tts.provider.aliyun': 'Aliyun TTS',
    'tts.provider.local': 'Local VITS2',
    'tts.responseType.json': 'JSON (base64)',
    'tts.responseType.blob': 'Raw Audio',
    'stt.title': '音声対話（クラウド STT）',
    ...
    'tts.mode.tts': 'TTS 音声合成', 'tts.mode.default': 'デフォルト', 'tts.mode.silent': '無音',
    ...
    'tts.test.btn': '音声テスト', 'tts.diagnose': 'TTS 診断',
