...
const I18N = {
  ...
  zh: {
    'lang.label': '语言',
    'tab.settings': '设置', 'tab.model': '模型', 'tab.emotion': '表情', 'tab.tts': 'TTS', 'tab.prompt': 'Prompt',     'tab.tavern': '酒馆', 'tavern.title': '酒馆模式预设管理', 'tavern.desc': '管理酒馆模式的世界观、角色和对话设定。', 'tavern.new': '新建预设', 'tavern.import': '导入 JSON', 'tavern.saved': '已保存的预设', 'tavern.select': '-- 选择预设 --', 'tavern.apply': '应用', 'tavern.edit': '编辑', 'tavern.export': '导出', 'tavern.delete': '删除', 'tavern.editor': '编辑预设', 'tavern.name': '名称', 'tavern.descLabel': '描述', 'tavern.userRole': '你的角色', 'tavern.aiRole': 'AI 角色', 'tavern.greeting': '开场白', 'tavern.systemPrompt': 'AI 人格设定', 'tavern.world': '世界观', 'tavern.diaryPrompt': '日记提示词', 'tavern.save': '保存', 'tavern.cancel': '取消', 'tavern.savedMsg': '预设已保存！', 'tavern.appliedMsg': '预设已应用，打开酒馆模式即可使用！', 'tab.enhance': '增强',
    'api.title': 'API 配置',
